...
import com.ileveli.ksp.Messages
...
class LocaleTest {
    ...
    fun test(){
        ...
        SimpleContextApplication.show({
            ...
            Assertions.assertEquals("Hello English", this.getString(Messages.locale_hello),"Default bundle is not loaded")
            setLocale(Locale("ru"),false)
            Assertions.assertEquals("Здрасте", this.getString(Messages.locale_hello),"Default bundle is not loaded")
